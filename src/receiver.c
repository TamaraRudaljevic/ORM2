...
/*   callaback f-ja koja se poziva od strane libpcap za svaki dolazece paket   */
...
/*   Provera da li su svi paketi primljeni   */
...
void *wifi_thread_function(void *param) {
	...
	/*  eth thread se zavrsio jer je sve primljeno preko wifi thread-a */
...
void *eth_thread_function(void *param) {
	...
	/*  eth thread se zavrsio jer je sve primljeno preko eth thread-a */
